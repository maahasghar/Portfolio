            ...
            <div className="row">
              <div className="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex justify-content-center flex-column about-text">
                ...
                <p>
                  ...
                  <br />
                  <br />
                  Recently, I have discovered my passion for illustration.  Thus, I decided to teach myself digital illustration from scratch, and bring creative ideas to life. <br />
                  <br />
